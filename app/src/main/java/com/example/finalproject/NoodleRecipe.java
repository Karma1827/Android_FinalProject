...
public class NoodleRecipe extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private WordListAdapter mAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_noodle_recipe);
        ...
        //改料理的縮圖
        mPictureList.add(R.drawable.noodle);
        mPictureList.add(R.drawable.noodle);
        mPictureList.add(R.drawable.noodle);
        mPictureList.add(R.drawable.noodle);
        mPictureList.add(R.drawable.noodle);
        ...
        mAdapter = new WordListAdapter(this, mWordList, mDetailList, mPictureList, 1);
